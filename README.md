...
* Create : `nx generate @joelcode/azure-func:http functionName`                       
...
1. Create a Nx workspace.
		...
		cd workspaceName
		yarn add tslib
		yarn add -D @joelcode/azure-func @google-cloud/functions-framework supertest @nrwl/lint @nrwl/jest @types/express
...
### Trigger: HTTP
    nx generate @joelcode/azure-func:http functionName
### Trigger: Pub/Sub
    nx generate @joelcode/azure-func:pubsub functionName
## Test the function
